  ...
  <header class="header-global">
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
        ...
        <p class="lead text-white mt-2 mb-1" style="font-size:25px;font-weight: bold;font-family: 'Jua', sans-serif; color='white'">b612</p>
      </router-link>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <li class="nav-item dropdown">
          <a href="#" class="nav-link" data-toggle="dropdown" role="button">
            ...
            <span class="nav-link-inner--text">B612</span>
          </a>
            ...
            <div class="dropdown-menu-inner">
              <router-link to="/house" class="media d-flex align-items-center">
                ...
                <div class="media-body ml-3">
                  <h6 class="heading text-primary mb-md-1">B612</h6>
                  <p class="description d-none d-md-inline-block mb-0">
                    B612와 함께 나만의 집을 찾아보세요.
                  </p>
                </div>
              </router-link>
              <router-link to="/news"
              ...
              >
                ...
                <div class="media-body ml-3">
                  <h5 class="heading text-warning mb-md-1">뉴스</h5>
                  <p class="description d-none d-md-inline-block mb-0">
                    매일의 최신 뉴스가 여러분을 찾아갑니다!
                  </p>
                </div>
              </router-link>
            </div>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <li class="nav-item dropdown" v-if="userInfo">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" @click.prevent="onClickLogout"> Logout </a>
